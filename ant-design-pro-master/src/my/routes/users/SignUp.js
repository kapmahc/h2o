...
import styles from '../../../routes/User/Register.less';
...
export default class Register extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.register.status === 'ok') {
      this.props.dispatch(routerRedux.push({pathname: '/user/register-result', state: {
          account
        }}));
    }
  }
      ...
      <Form onSubmit={this.handleSubmit}>
        ...
        <FormItem>
          <InputGroup compact="compact">
            <Select size="large" value={prefix} onChange={this.changePrefix} style={{
                width: '20%'
              }}>
